...
export function Navbar() {
    return <div className='p-3 flex items-center gap-3 justify-around'>
        ...
        <span className='flex gap-3'>
            <span className='px-3 py-1 rounded-sm text-white'>Log in</span>
            <span className='px-3 py-1 rounded-sm bg-white text-black'>Sign up</span>
        </span>
    </div>
}
